...
typedef struct {
	...
	u32 size[NF_3DSPRITES];		// Tama�o del bloque libre para reusar
...
// Escala el sprite al tama�o indicado (0/64/512)
...
// transparencia, selecciona un valor para alpha de 31 o especifica como poly_id el n� 0.
